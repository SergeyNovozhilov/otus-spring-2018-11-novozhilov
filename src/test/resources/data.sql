...
insert into BOOKS_AUTHORS (id, book, author) values(RANDOM_UUID(), (select id from BOOKS where title='Book by Jerome C. Jerome'),(select id from AUTHORS where name='Jerome C. Jerome'));
